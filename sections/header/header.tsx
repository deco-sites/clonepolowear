      ...
      <div className="fixed w-full z-20">
        <div className="bg-black flex justify-around pt-5 ">
          <img
           ...
           src={url}
           alt={alt}/>
           <input type="text" placeholder={placeholder} className="input input-bordered w-3/5" />
           <div className="flex w-16 justify-around">
           <svg width="25px" class="text-slate-100" data-darkreader-inline-stroke="" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
